...
namespace SmartElectronicsApi.DataAccess.Migrations
{
    ...
    [Migration("20250329230715_NewPropToCampaign")]
    partial class NewPropToCampaign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.BranchCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("branchCampaignProducts");
                });
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.CommentImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.GuestOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsGottenFromStore")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("PurchasedProducVariationtId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ShippedToken")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.BranchCampaign", b =>
                {
                    b.HasOne("SmartElectronicsApi.Core.Entities.Branch", "Branch")
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.CommentImage", b =>
                {
                    b.HasOne("SmartElectronicsApi.Core.Entities.Comment", "Comment")
            ...
            modelBuilder.Entity("SmartElectronicsApi.Core.Entities.OrderItem", b =>
                {
                    b.HasOne("SmartElectronicsApi.Core.Entities.Order", "Order")
                        .WithMany("Items")
