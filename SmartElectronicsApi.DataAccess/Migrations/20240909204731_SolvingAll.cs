...
{
    /// <inheritdoc />
    public partial class SolvingAll : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDealOfTheWeek = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productVariationColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_productVariationColors_ProductVariations_ProductVariationId",
                        column: x => x.ProductVariationId,
                        principalTable: "ProductVariations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_productVariationColors_colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_productVariationColors_ColorId",
                table: "productVariationColors",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_productVariationColors_ProductVariationId",
                table: "productVariationColors",
